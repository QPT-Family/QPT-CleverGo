# -*- coding: utf-8 -*-
# @Time    : 2021/9/25 21:39
# @Author  : He Ruizhi
# @File    : info_display.py
# @Software: PyCharm
...
class InfoDisplay:
    # Pygame信息展示控件
    def __int__(self, screen: pygame.Surface,
                position: Union[int, List[int], Tuple[int]],
                text_num: int = 5,
                text_color: Union[List[int], Tuple[int]] = (0, 0, 0),
                font_size: int = 14,
                bg_color: Union[List[int], Tuple[int]] = (225, 225, 225),
                display_size: Union[List[int], Tuple[int]] = (100, 200),
                outer_edge_color: Union[List[int], Tuple[int]] = (240, 240, 240),
                inner_edge_color: Union[List[int], Tuple[int]] = (240, 240, 240)) -> None:
        """
        初始化Pygame信息展示控件

        :param screen: 控件绘制屏幕
        :param position: 控件绘制位置
        :param text_num: 最大绘制信息数
        :param text_color: 文字颜色
        :param font_size: 文字大小
        :param bg_color: 信息展示控件背景颜色
        :param display_size: 信息展示控件大小
        :param outer_edge_color: 信息展示控件外边框颜色
        :param inner_edge_color: 信息展示控件内边框颜色
        :return:
        """
